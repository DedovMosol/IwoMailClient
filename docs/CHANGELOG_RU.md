...
- Исправлена обрезка нижнего ряда на узком виджете: кнопка синхронизации и аватары больше не «уезжают» за край — число и размер аватаров подстраиваются под ширину, метка времени синхронизации показывается на широком виджете (W-1)
- Время последней синхронизации больше не выглядит «сегодняшним» для старых синхронизаций: для не-сегодняшних добавляется дата (W-2)
...
- Внутренняя чистка виджета (KISS): удалены неиспользуемые поля события, вычислявшиеся на каждый рендер (W-4)
