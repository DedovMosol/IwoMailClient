...
- Стабильность и синхронизация: ускорена работа на больших ящиках, уменьшены дубли, усилена защита от гонок/утечек и ошибок в Push/Sync/уведомлениях.
- Почта и контакты: улучшены reply/forward и mark-as-read, доработаны черновики и папки, усилены валидация и экспорт контактов.
- Календарь, задачи и виджет: расширена поддержка повторов/вложений/онлайн-ссылок, улучшена актуальность данных и масштабирование виджета.
- Интерфейс: унифицированы темы и визуальные компоненты, улучшены диалоги, скроллбар и UX-взаимодействия.
- Безопасность и надёжность: усилена обработка чувствительных данных и добавлен аудит `docs/SECURITY_MEMORY_RACE_NETWORK_AUDIT.md`.
- Совместимость: Exchange 2007 SP1+ сохранена.
