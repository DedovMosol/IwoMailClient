...
### Улучшения
- Кэширование имён отправителей — если имя пришло в одном письме, оно используется для всех писем с этого адреса
- Анимация пульсации для FAB кнопок (карандаш, плюсик) — отключается в настройках

### Исправления
- Исправлено дублирование подписи при редактировании
- Участники календаря теперь выделены синим цветом и кликабельные (как организатор)
- Исправлено дублирование описания в событиях календаря
- Исправлен счётчик контактов организации (без своего аккаунта)
- Исправлено сохранение выделения писем при повороте экрана
- Исправлена повторная отмена удаления/отправки после первой отмены
