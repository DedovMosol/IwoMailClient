...
- **Смена аккаунта в письме** — автоматическая подстановка подписи и синхронизация контактов
- **Обновление по архитектуре** — скачивается APK для вашей архитектуры
- **Задачи Exchange 2007** — исправлено создание задач с датами
- **Исправления** — mailto: при повороте экрана, кнопки в альбомном режиме, навигация после удаления аккаунта
