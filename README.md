...
- 🔒 **Совместимость с Exchange 2007** — поддержка TLS 1.0-1.3 через Conscrypt
...
| Календарь Exchange (создание/редактирование/удаление) | ⚠️ Beta |
...
| Задачи Exchange (создание/редактирование/удаление) | ⚠️ Beta |
...
- **Исправления багов v1.5.0** — синхронизация, календарь, задачи, уведомления
- ⚠️ **Календарь и Задачи в бета-режиме** — возможны ошибки
