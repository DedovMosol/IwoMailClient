...
- **Серверные черновики** — черновики синхронизируются с сервером через EWS
- **Синхронизация черновиков** — удаления из Outlook теперь отображаются
- **SSL исправление** — исправлена ошибка с самоподписанными сертификатами
- **EWS аутентификация** — fallback на Basic auth
