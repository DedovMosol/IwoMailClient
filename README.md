...
- 📧 **Exchange ActiveSync** — поддержка EAS 12.0-14.1 (Exchange 2007+). Протестировано на Exchange 2007 SP1
...
- ✅ **Почта** — синхронизация, отправка с вложениями, поиск, фильтры, избранное, управление папками, черновики, отложенная отправка
