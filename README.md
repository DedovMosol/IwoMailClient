...
- **Первичная синхронизация** — календарь, заметки и контакты синхронизируются при первом запуске
- **Кликабельные email** — email организатора и участников в календаре открывают написание письма
- **Кликабельные ссылки** — URL в месте события открываются в браузере
- **Обновление в реальном времени** — письма обновляются автоматически во время фоновой синхронизации
- **Боковое меню** — Контакты, Заметки и Календарь перенесены под Избранное
- **Исправления** — утечки памяти, массовое удаление контактов, дублирование email
