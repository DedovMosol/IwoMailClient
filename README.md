...
- **Назначение задач** — возможность назначать задачи другим пользователям
- **Задачи для Exchange 2007** — создание задач работает на Exchange 2007 через EWS
- **Приглашения на встречи** — принятие iCalendar приглашений и добавление в календарь
- **Приглашение участников** — при создании события можно пригласить участников
- **Приложение по умолчанию** — обработка mailto: ссылок и Share
